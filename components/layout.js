      ...
      >
        ...
        >
          <Flex id="contact" sx={{ justifyContent: 'center' }}>
            ...
            <A href="https://github.com/SanchithaD/Superposition-Lynbrook-Hackathon" title="GitHub" sx={{ mx: 2 }}>
              <Icon glyph="github" size={36} />
            </A>
            <A
              href="https://www.instagram.com/superpositionlhs/?hl=en"
              title="Instagram"
              sx={{ mx: 2 }}
            >
              <Icon glyph="instagram" size={36} />
            </A>
            <A href="mailto:supernova.lhs@gmail.com" title="Email" sx={{ mx: 2 }}>
